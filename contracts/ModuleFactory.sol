...
contract ModuleFactory {
    ...
    function createModuleAndEnable(IGnosisSafe safe, ModuleType modType) external {
        if (modType == ModuleType.REVOKE_MODULE) {
            RevokeModule module = new RevokeModule();
            ...
            AaveWithdrawModule module = new AaveWithdrawModule();
